...
const ProjectsList: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Search and Filters */}
      <form onSubmit={handleSearch} className="bg-white/60 backdrop-blur-lg rounded-2xl p-4 border border-[#9fdbc2]/20 shadow-lg">
        <div className="flex flex-col md:flex-row gap-4">
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 bg-white/50 border border-[#9fdbc2]/30 rounded-xl text-[#0c272d] focus:outline-none focus:ring-2 focus:ring-[#14a67e]/20 transition-all duration-300"
            />
          </div>
          <div className="w-full md:w-48">
            <select
              ...
              className="w-full px-4 py-2 bg-white/50 border border-[#9fdbc2]/30 rounded-xl text-[#0c272d] focus:outline-none focus:ring-2 focus:ring-[#14a67e]/20 transition-all duration-300"
            >
          ...
          <button
            type="submit"
            className="px-6 py-2 bg-[#14a67e] text-white rounded-xl hover:bg-[#14a67e]/90 transition-all duration-300 whitespace-nowrap"
          >
            Search
          </button>
        </div>
...
const ProjectCard: React.FC<{ project: Project }> = ({ project }) => {
  ...
  return (
    <Link href={`/dashboard/projects/${project.proyect_id}`}>
      <div className="bg-white/60 backdrop-blur-lg rounded-2xl p-6 border border-[#9fdbc2]/20 shadow-lg hover:shadow-xl transition-all duration-300 cursor-pointer hover:scale-105">
