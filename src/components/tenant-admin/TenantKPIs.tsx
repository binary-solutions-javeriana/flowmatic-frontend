    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
      {kpiCards.map((card, index) => {
        ...
        return (
          <div
            key={card.title}
            className={`${card.bgColor} dark:bg-gray-800/50 rounded-2xl p-6 hover:shadow-lg transition-all duration-300 hover:scale-105 border border-transparent hover:border-current/20 dark:border-gray-700/50`}
            style={{
