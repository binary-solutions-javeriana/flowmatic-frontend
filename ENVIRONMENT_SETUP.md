...
NEXT_PUBLIC_API_BASE_URL=http://10.43.103.86:3000
...
- API Base URL: `http://10.43.103.86:3000`
- API Version: `v1`

## API Endpoints

With the default configuration, the following endpoints will be available:
- Health Check: `http://10.43.103.86:3000/health`
- Auth API: `http://10.43.103.86:3000/v1/auth/`
